...
public:
    ...
    /// @param projectiles - a reference to the IAddProjectile interface of the ProjectileManager manager.
    /// @param event_queue - a reference to the IAddEvent interface of the EventManager.
    EventFactory(IAddProjectile& projectiles, IAddEvent& event_queue);
