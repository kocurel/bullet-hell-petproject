...
private:
    ...
    /// @brief Player object
    Player player_;
     /// @brief Calls process on Player object. Exists for multithreading purposes.
     /// @param game - reference to the Game instance
     static void processPlayer(Game& game);
     /// @brief Calls process on EnemyManager object. Exists for multithreading purposes.
     /// @param game - reference to the Game instance
     static void processEnemies(Game& game);
     /// @brief Checks the input. Loads a stage when the player presses a number corresponding to a stage files.
