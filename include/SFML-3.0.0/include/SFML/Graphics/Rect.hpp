...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Converts the rectangle to another id of rectangle
    ///
    ////////////////////////////////////////////////////////////
    template <typename U>
...
// Create id aliases for the most common types
...
/// don't intersect.
///
/// `sf::Rect` is a template and may be used with any numeric id, but
/// for simplicity id aliases for the instantiations used by SFML are given:
