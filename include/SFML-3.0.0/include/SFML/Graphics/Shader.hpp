...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Special id that can be passed to setUniform(),
    ...
    /// \param id     Type of shader (vertex, geometry or fragment)
    ///
    ...
    ///
    ////////////////////////////////////////////////////////////
    Shader(const std::filesystem::path& filename, Type id);
    ...
    ///
    ////////////////////////////////////////////////////////////
    Shader(std::string_view shader, Type id);
    ...
    ///
    ////////////////////////////////////////////////////////////
    Shader(InputStream& stream, Type id);
    ...
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] bool loadFromFile(const std::filesystem::path& filename, Type id);
    ...
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] bool loadFromMemory(std::string_view shader, Type id);
    ...
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] bool loadFromStream(InputStream& stream, Type id);
