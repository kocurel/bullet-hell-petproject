...
// Windows' HWND is a id alias for struct HWND__*
...
// Define id alias symbol so that Doxygen can attach some documentation to it
...
/// \ingroup window
///
/// Low-level window handle id, specific to each platform.
///
/// Platform        | Type
/// ----------------|------------------------------------------------------------
/// Windows         | \p HWND
