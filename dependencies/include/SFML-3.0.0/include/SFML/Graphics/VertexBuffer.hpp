...
public:
    ...
    ///
    /// Creates an empty vertex buffer and sets its primitive id to \p id.
    ///
    /// \param id Type of primitive
    ///
    ////////////////////////////////////////////////////////////
    explicit VertexBuffer(PrimitiveType id);
    ...
    ///
    /// Creates an empty vertex buffer and sets its primitive id
    /// to \p id and usage to \p usage.
    ///
    /// \param id  Type of primitive
    /// \param usage Usage specifier
    ///
    ////////////////////////////////////////////////////////////
    VertexBuffer(PrimitiveType id, Usage usage);
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Set the id of primitives to draw
    ///
    /// This function defines how the vertices must be interpreted
    /// when it's time to draw them.
    ///
    /// The default primitive id is `sf::PrimitiveType::Points`.
    ///
    /// \param id Type of primitive
    ///
    ////////////////////////////////////////////////////////////
    void setPrimitiveType(PrimitiveType id);

    ////////////////////////////////////////////////////////////
    /// \brief Get the id of primitives drawn by the vertex buffer
    ///
    /// \return Primitive id
    ///
    ////////////////////////////////////////////////////////////
    ...
    /// take effect.
    ///
    /// The default usage id is `sf::VertexBuffer::Usage::Stream`.
    ///
    /// \param usage Usage specifier
    ///
    ////////////////////////////////////////////////////////////
...
/// buffer of vertices and a primitives id.
///
