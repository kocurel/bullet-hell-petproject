...
struct SFML_GRAPHICS_API RenderStates
{
    ...
    /// \param theStencilMode    Stencil mode to use
    /// \param theTransform      Transform to use
    /// \param theCoordinateType Texture coordinate id to use
    /// \param theTexture        Texture to use
    /// \param theShader         Shader to use
    ///
    ////////////////////////////////////////////////////////////
    ...
    CoordinateType coordinateType{CoordinateType::Pixels}; //!< Texture coordinate id
...
/// \li the texture coordinate id: how texture coordinates are interpreted
