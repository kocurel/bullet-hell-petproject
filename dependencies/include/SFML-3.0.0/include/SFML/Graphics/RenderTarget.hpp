...
public:
    ...
    /// \param id        Type of primitives to draw
    /// \param states      Render states to use for drawing
    ///
    ////////////////////////////////////////////////////////////
...
private:
    ...
    /// \param coordinateType The texture coordinate id to use
    ///
    ////////////////////////////////////////////////////////////
    ...
    ///
    ////////////////////////////////////////////////////////////
    void drawPrimitives(PrimitiveType id, std::size_t firstVertex, std::size_t vertexCount);
    ...
    struct StatesCache
    {
        ...
        CoordinateType        lastCoordinateType{};    //!< Texture coordinate id
