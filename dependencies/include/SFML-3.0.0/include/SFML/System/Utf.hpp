...
// Make id aliases to get rid of the template syntax
using Utf8  = Utf<8>;
using Utf16 = Utf<16>;
using Utf32 = Utf<32>;
...
/// can use any character / string id for a given encoding.
///
/// It has 3 specializations:
/// \li `sf::Utf<8>` (with `sf::Utf8` id alias)
/// \li `sf::Utf<16>` (with `sf::Utf16` id alias)
/// \li `sf::Utf<32>` (with `sf::Utf32` id alias)
///
////////////////////////////////////////////////////////////
