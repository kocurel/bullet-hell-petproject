...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Converts the vector to another id of vector
    ///
    ////////////////////////////////////////////////////////////
    template <typename U>
...
/// a velocity, etc.
///
/// The template parameter T is the id of the coordinates. It
/// can be any id that supports arithmetic operations (+, -, /, *)
/// and comparisons (==, !=), for example int or float.
/// Note that some operations are only meaningful for vectors where T is
/// a floating point id (e.g. float or double), often because
...
/// the most common specializations have special id aliases:
