...
public:
    ...
    /// @param projectiles - a reference to the IAddProjectile interface of the ProjectileManager class, passed to the EventFactory.
    ...
    EventParser(IAddProjectile& projectiles, IAddEvent& event_manager);
