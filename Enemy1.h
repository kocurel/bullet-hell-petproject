...
class Enemy1 : public Enemy, private SeriesInLinePattern, private TripleStraightPattern, private UpwardSprayPattern {
protected:
...
public:
    ...
    explicit Enemy1(IAddProjectile& projectiles);
